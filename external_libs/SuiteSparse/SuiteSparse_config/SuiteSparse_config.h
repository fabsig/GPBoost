...
#define SUITESPARSE_DATE "Aug 16, 2026"
#define SUITESPARSE_MAIN_VERSION    7
#define SUITESPARSE_SUB_VERSION     14
#define SUITESPARSE_SUBSUB_VERSION  0

// version format x.y
#define SUITESPARSE_VER_CODE(main,sub) ((main) * 1000 + (sub))
#define SUITESPARSE_VERSION SUITESPARSE_VER_CODE(7, 14)

// version format x.y.z
#define SUITESPARSE__VERCODE(main,sub,patch) \
    (((main)*1000ULL + (sub))*1000ULL + (patch))
#define SUITESPARSE__VERSION SUITESPARSE__VERCODE(7,14,0)
...
//------------------------------------------------------------------------------
// GPBoost modification: route BLAS/LAPACK calls to the bundled Eigen kernels
//------------------------------------------------------------------------------

// GPBoost ships CHOLMOD without requiring an external BLAS/LAPACK. When
// GPB_SUITESPARSE_INTERNAL_BLAS is defined, every BLAS/LAPACK symbol that
// SuiteSparse calls is renamed to a "gpb_blas_" prefixed one, implemented on
// top of Eigen in external_libs/SuiteSparse/EigenBLAS. The prefix keeps these
// definitions from colliding with a real BLAS that the host program may also
// link (R's libRblas, OpenBLAS, MKL, ...). Leave the macro undefined to call a
// genuine Fortran BLAS instead.

#ifdef GPB_SUITESPARSE_INTERNAL_BLAS

    #undef  SUITESPARSE_BLAS
    #define SUITESPARSE_BLAS(name,NAME) SUITESPARSE_CAT (gpb_blas_, name)
