...
opt_params = gpb.grid_search_tune_parameters(param_grid=param_grid_small, params=params, nfold=4,
                                             gp_model=gp_model, use_gp_model_for_validation=True,
                                             train_set=data_train, verbose_eval=1, num_boost_round=1000, 
                                             early_stopping_rounds=10, seed=1,
                                             metrics='binary_logloss', num_try_random=None)
print("Found tuning parameters usind deterministic grid search:")
print(opt_params)
...
opt_params = gpb.grid_search_tune_parameters(param_grid=param_grid_large, params=params, nfold=4,
                                             gp_model=gp_model, use_gp_model_for_validation=True,
                                             train_set=data_train, verbose_eval=1, num_boost_round=1000, 
                                             early_stopping_rounds=10, seed=1,
                                             metrics='binary_logloss', num_try_random=20)
print("Found tuning parameters usind random grid search:")
print(opt_params)
...
opt_params = gpb.grid_search_tune_parameters(param_grid=param_grid_small, params=params, nfold=4,
                                             ...
                                             train_set=data_train, verbose_eval=1, num_boost_round=1000, 
                                             early_stopping_rounds=10, seed=1,
                                             metrics='auc', num_try_random=5)
print("Found tuning parameters:")
print(opt_params)
...
param_grid = {'learning_rate': [0.1,0.01], 'min_data_in_leaf': [20,100],
              'max_depth': [5,10], 'num_leaves': 2**17, 'max_bin': [255,1000]}
opt_params = gpb.grid_search_tune_parameters(param_grid=param_grid, params=params, folds=folds,
                                             gp_model=gp_model, use_gp_model_for_validation=True,
                                             train_set=data_train, verbose_eval=1, num_boost_round=1000, 
                                             early_stopping_rounds=10, seed=1,
                                             metrics='binary_logloss', num_try_random=5)
print("Found tuning parameters usind validation data:")
print(opt_params)
