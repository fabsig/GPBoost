...
#   form of (quasi-) Newton's method and does not require  a learning rate
...
plot8 <- ggplot(data = data.frame(s_1=coords_test[,1],s_2=coords_test[,2],b=b_all[1:nx^2]),aes(x=s_1,y=s_2,color=b)) + geom_point(size=2, shape=15) + scale_color_viridis(option = "B") + ggtitle("'True' GP and obs. locations") + geom_point(data = data.frame(s_1=coords[,1],s_2=coords[,2],y=y),aes(x=s_1,y=s_2),size=1,col="white", alpha=1, shape=3)
