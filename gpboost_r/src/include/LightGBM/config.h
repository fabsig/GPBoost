...
struct Config {
  ...
  */
  ...
  // desc = this is arguably the most important tuning parameter, in particular for regession settings
  int num_iterations = 100;

  // alias = shrinkage_rate, eta
  // check = >0.0
  // desc = shrinkage rate or damping parameter
  // desc = smaller values lead to higher predictive accuracy but require more computational time since more boosting iterations are needed
  ...
  // check = >1
  // check = <=131072
  // desc = maximal number of leaves of a tree
