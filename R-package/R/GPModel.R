...
#' slow threads can slow down an entire model. The number of threads that OpenMP is configured to use
#' is kept if the environment variable OMP_NUM_THREADS is set or if the cores of the CPU cannot be
#' determined.
