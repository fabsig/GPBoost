...
#'       \item { result["random_effect_mean"] are the predictive means of the \code{gp_model}. }
...
#'   }
#'   }
#'   \item { If there is no \code{gp_model} or \code{predcontrib} or \code{ignore_gp_model} 
