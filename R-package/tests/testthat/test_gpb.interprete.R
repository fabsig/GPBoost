...
test_that("gpb.intereprete works as expected for binary classification", {
...
test_that("gpb.intereprete works as expected for multiclass classification", {
    data(iris)
